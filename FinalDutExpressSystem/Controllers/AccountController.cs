...
namespace FinalDutExpressSystem.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var userId = db.Users.Where(x => x.UserName == user.UserName).Select(x => x.Id);
            string updateId = "";
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl,string searchString)
        {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterViewModel model, CourseModel m, itsModel model1)
        {
            if (ModelState.IsValid)
            {
